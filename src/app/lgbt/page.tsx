...
import { Film, Search, Calendar, Star, ChevronLeft, ChevronRight, Flag } from 'lucide-react'
...
function LGBTPageContent() {
    ...
    const fetchMovies = async () => {
      try {
        ...
        const filters = {
          ...
          tag: 'LGBT', // Filter specifically for LGBT tag
          sortBy,
          sortOrder,
          page: currentPage,
  ...
  const updateURLParams = (updates: Record<string, string | number | undefined>) => {
    ...
    router.push(`/lgbt?${params.toString()}`, { scroll: false })
  }
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white">LGBT</h1>
          ...
          <form onSubmit={handleSearch} className="mb-6">
            <div className="relative max-w-md">
              ...
              <Input
                type="text"
                placeholder="Search LGBT content..."
                value={searchQuery}
        ...
        {/* {!loading && (
          <div className="flex items-center justify-between mb-6">
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Found {totalCount} LGBT {totalCount === 1 ? 'title' : 'titles'}
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            <div className="w-16 h-16 rounded-full bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 flex items-center justify-center mx-auto mb-4">
              <Flag className="w-8 h-8 text-white" />
            </div>
            <h3 className="text-xl font-semibold text-gray-600 dark:text-gray-400 mb-2">
              No LGBT content found
            </h3>
            <p className="text-gray-500">
              {searchQuery 
                ? `No LGBT content matches "${searchQuery}". Try different search terms.`
                : 'No LGBT content available with the selected filters.'}
            </p>
          </div>
        )}
      </div>
