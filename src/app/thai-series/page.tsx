...
import { Film, Search, Calendar, Star, ChevronLeft, ChevronRight, Palmtree } from 'lucide-react'
...
function ThaiSeriesPageContent() {
    ...
    const fetchMovies = async () => {
      try {
        ...
        const filters = {
          ...
          tag: 'thai series', // Filter specifically for thai series tag
          sortBy,
          sortOrder,
          page: currentPage,
  ...
  const updateURLParams = (updates: Record<string, string | number | undefined>) => {
    ...
    router.push(`/thai-series?${params.toString()}`, { scroll: false })
  }
    ...
    <div className="min-h-screen bg-white dark:bg-black">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
            ...
            <div>
              <h1 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white">Thai Series</h1>
          ...
          <form onSubmit={handleSearch} className="mb-6">
            <div className="relative max-w-md">
              ...
              <Input
                type="text"
                placeholder="Search Thai content..."
                value={searchQuery}
        ...
        {!loading && (
          <div className="flex items-center justify-between mb-6">
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Found {totalCount} Thai {totalCount === 1 ? 'title' : 'titles'}
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <h3 className="text-xl font-semibold text-gray-600 dark:text-gray-400 mb-2">
              No Thai content found
            </h3>
            <p className="text-gray-500">
              {searchQuery 
                ? `No Thai content matches "${searchQuery}". Try different search terms.`
                : 'No Thai content available with the selected filters.'}
            </p>
          </div>
        )}
      </div>
