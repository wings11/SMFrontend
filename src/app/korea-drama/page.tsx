...
import { Film, Search, Calendar, Star, ChevronLeft, ChevronRight, Heart } from 'lucide-react'
...
function KoreaDramaPageContent() {
    ...
    const fetchMovies = async () => {
      try {
        ...
        const filters = {
          ...
          tag: 'korea drama', // Filter specifically for korea drama tag
          sortBy,
          sortOrder,
          page: currentPage,
  ...
  const updateURLParams = (updates: Record<string, string | number | undefined>) => {
    ...
    router.push(`/korea-drama?${params.toString()}`, { scroll: false })
  }
    ...
    <div className="min-h-screen bg-white dark:bg-black">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
            ...
            <div>
              <h1 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white">Korea Drama</h1>
              {/* <p className="text-gray-600 dark:text-gray-400">Discover amazing Korean dramas and movies</p> */}
        ...
        {/* {!loading && (
          <div className="flex items-center justify-between mb-6">
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Found {totalCount} Korean {totalCount === 1 ? 'title' : 'titles'}
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <h3 className="text-xl font-semibold text-gray-600 dark:text-gray-400 mb-2">
              No Korean content found
            </h3>
            <p className="text-gray-500">
              {searchQuery 
                ? `No Korean content matches "${searchQuery}". Try different search terms.`
                : 'No Korean content available with the selected filters.'}
            </p>
          </div>
        )}
      </div>
...
export default function KoreaDramaPage() {
  return (
