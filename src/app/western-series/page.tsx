...
import { Film, Search, Calendar, Star, ChevronLeft, ChevronRight, MapPin } from 'lucide-react'
...
function WesternSeriesPageContent() {
    ...
    const fetchMovies = async () => {
      try {
        ...
        const filters = {
          ...
          tag: 'western series', // Filter specifically for western series tag
          sortBy,
          sortOrder,
          page: currentPage,
  ...
  const updateURLParams = (updates: Record<string, string | number | undefined>) => {
    ...
    router.push(`/western-series?${params.toString()}`, { scroll: false })
  }
    ...
    <div className="min-h-screen bg-white dark:bg-black">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
            ...
            <div>
              <h1 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white">Western Series</h1>
          ...
          <form onSubmit={handleSearch} className="mb-6">
            <div className="relative max-w-md">
              ...
              <Input
                type="text"
                placeholder="Search Western content..."
                value={searchQuery}
        ...
        {/* {!loading && (
          <div className="flex items-center justify-between mb-6">
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Found {totalCount} Western {totalCount === 1 ? 'title' : 'titles'}
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <h3 className="text-xl font-semibold text-gray-600 dark:text-gray-400 mb-2">
              No Western content found
            </h3>
            <p className="text-gray-500">
              {searchQuery 
                ? `No Western content matches "${searchQuery}". Try different search terms.`
                : 'No Western content available with the selected filters.'}
            </p>
          </div>
        )}
      </div>
...
export default function WesternSeriesPage() {
  return (
