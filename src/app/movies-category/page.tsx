...
import { Film, Search, Calendar, Star, ChevronLeft, ChevronRight } from 'lucide-react'
...
export default function MoviesPage() {
    ...
    const fetchMovies = async () => {
      try {
        ...
        const filters = {
          ...
          tag: 'movie', // Filter specifically for movie tag
          sortBy,
          sortOrder,
          page: currentPage,
  ...
  const updateURLParams = (updates: Record<string, string | number | undefined>) => {
    ...
    router.push(`/movies-category?${params.toString()}`, { scroll: false })
  }
    ...
    <div className="min-h-screen bg-white dark:bg-black">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
            ...
            <div>
              <h1 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white">Movie</h1>
        ...
        {/* {!loading && (
          <div className="flex items-center justify-between mb-6">
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Found {totalCount} {totalCount === 1 ? 'movie' : 'movies'}
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-gray-500">
              {searchQuery 
                ? `No movies match "${searchQuery}". Try different search terms.`
